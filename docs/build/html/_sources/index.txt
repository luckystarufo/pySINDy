...
Description
--------------------
PySINDy is a python package for blablabla ... (TBD)

Installation
--------------------
PyDMD requires requires numpy, scipy, matplotlib, findiff, pytest, sphinx (for the
documentation). The code is compatible with Python 2.7 and Python 3.6. It can be
